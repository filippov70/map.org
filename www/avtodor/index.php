...
<link href="tutorial2/core.css" type="text/css" rel="stylesheet">
<link href="tutorial2/style_002.css" type="text/css" rel="stylesheet">
<link href="tutorial2/style_003.css" type="text/css" rel="stylesheet">
<link href="tutorial2/styles.css" type="text/css" rel="stylesheet">
<link href="tutorial2/template_styles.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="tutorial2/core.js"></script>
<script type="text/javascript" src="tutorial2/core_ajax.js"></script>
<script type="text/javascript" src="tutorial2/session.js"></script>

<title>Объекты дорожного сервиса</title>
<script src="tutorial2/jquery-1.js" type="text/javascript" language="javascript"></script>
<script src="tutorial2/jquery_002.js" type="text/javascript" language="javascript"></script>
<script src="tutorial2/jquery_003.js" type="text/javascript" language="javascript"></script>
<script src="tutorial2/jquery_004.js" type="text/javascript" language="javascript"></script>
<script src="tutorial2/jquery-ui-1.js" type="text/javascript" language="javascript"></script>
<script src="tutorial2/jquery.js" type="text/javascript" language="javascript"></script>
<script src="tutorial2/site.js" type="text/javascript" language="javascript"></script>
...
<link href="tutorial2/jquery.css" type="text/css" rel="stylesheet">
<link href="tutorial2/style.css" type="text/css" rel="stylesheet">


	    <!--ExtJs-->
	    <script type="text/javascript" charset="utf-8" src="../lib/extjs/ext-all.js"></script>
	    <link rel="stylesheet" type="text/css" href="../lib/extjs/resources/css/ext-all.css"/>
	    <link rel="stylesheet" type="text/css" href="../lib/extjs/resources/ext-theme-gray/ext-theme-gray-all.css"/>
	    ...
	    <!--script src="../lib/OpenLayers/yandex/OL_Yandex.js"></script-->
	    ...
	    <script type="text/javascript" charset="utf-8" src="../lib/geoext/src/GeoExt/GeoExt.js"></script>
...
<div id="all_wrapper">
		<div class="top_1_wrapper limited">
			<a href="#"><img src="tutorial2/logo_top.png" alt="" class="logo"></a>
			<div class="top_langs">
				<a href="#" class="lang_rus current"><img src="tutorial2/lang_flag_rus.png" alt=""> РУС</a>
				<a href="#" class="lang_eng"><img src="tutorial2/lang_flag_eng.png" alt=""> ENG</a>
			</div>
...
<script src="tutorial2/script_003.js" type="text/javascript"></script>
<ul>
				...
				<div class="top_img floats_wrapper">
					<div class="top_img_mask_wrapper">
						<img src="tutorial2/Road_serv.JPG">
		...
		<div class="center_wrapper limited">
			<div class="floats_wrapper">
				<a href="#" class="print_link"><img src="tutorial2/ico_print.png" alt=""> Версия для печати</a>
				<div class="path">
<h1>Пользователям автодорог</h1><h4><a href="#" title="Трасса М-1 «Беларусь»">Трасса М-1 «Беларусь»</a></h4><h4><a href="#" title="Объекты дорожного сервиса">Объекты дорожного сервиса</a></h4>				</div>
			...
			<div class="floats_wrapper">
				<div class="left_part">	
 <script src="tutorial2/script.js" type="text/javascript"></script><div class="menu_left_wrapper">
