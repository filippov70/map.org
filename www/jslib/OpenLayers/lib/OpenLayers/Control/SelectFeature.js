...
OpenLayers.Control.SelectFeature = OpenLayers.Class(OpenLayers.Control, {
    ...
    hover: false,
     ...
     /**
     * APIProperty: onDblSelect
     * {Function} Optional function to be called when a feature is selected.
     * The function should expect to be called with a feature.
     */
    onDblSelect: function() {},
    ...
    /**
     * APIProperty: onHover
     * {Function} Optional function to be called when a feature is hovered.
     * The function should expect to be called with a feature.
     */
    onHover: function() {},

    /**
     * APIProperty: onUnhover
     * {Function} Optional function to be called when a feature is unhoverd.
     *                  The function should expect to be called with a feature.
     */
    onUnhover: function() {},
    ...
    unselectAll: function(options) {
        ...
        for(var i=this.layer.selectedFeatures.length-1; i>=0; --i) {
            ...
            if(!options || options.except != feature) {
                // Don't call unselect feature because it will removeItem from 
                // this.layer.selectedFeatures which may result in a undefined feature
     ...
     * Called when the feature handler detects a dblclick on a feature
     *
     * Parameters:
     ...
     * selected, and call the onDblSelect function.
     *
     * Parameters:
     * feature - {<OpenLayers.Feature.Vector>}
     */
    dblselect: function(feature) {
        this.onDblSelect(feature);
    },
     ...
     * feature - {<OpenLayers.Feature.Vector>}
     */
    unxhover: function(feature) {
        this.onUnhover(feature);
    },
